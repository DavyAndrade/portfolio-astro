...
Este arquivo contextualiza o projeto para que Gemini possa ajudar de forma eficiente e alinhada com os objetivos de aprendizado.
...
## Comportamento esperado de Gemini
...
- Usar Google Search Grounding quando relevante para buscar docs atualizadas
...
- Usar o recurso de pensamento (Thinking) para elaborar a melhor abordagem socrática antes de responder
...
## Nota sobre este arquivo vs CLAUDE.md

Ambos os arquivos existem intencionalmente como parte do estudo de ferramentas de IA.
Davy está aprendendo a trabalhar com diferentes modelos e comparando comportamentos, capacidades e formas de prompting entre Gemini e Claude.
